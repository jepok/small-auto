...
var mockSingleListings_1 = require('./mockSingleListings');
var core_1 = require('angular2/core');
var SingleListingService = (function () {
    function SingleListingService() {
    }
    SingleListingService.prototype.getSingleListings = function () {
        return Promise.resolve(mockSingleListings_1.SINGLELISTINGS);
    };
    ;
    SingleListingService.prototype.getSingleListing = function (id) {
        return Promise.resolve(mockSingleListings_1.SINGLELISTINGS).then(function (singleListings) { return singleListings.filter(function (singleListing) { return singleListing.id === id; })[0]; });
    };
    SingleListingService.prototype.getSingleFeaturedListings = function () {
        return Promise.resolve(mockSingleListings_1.SINGLELISTINGS)
    ...
    return SingleListingService;
}());
exports.SingleListingService = SingleListingService;
//# sourceMappingURL=singleListing.service.js.map